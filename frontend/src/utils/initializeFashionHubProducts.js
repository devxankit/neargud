...
export const initializeFashionHubProducts = () => {
  ...
  const existingProducts = savedProducts ? JSON.parse(savedProducts) : initialProducts;
  ...
  const dummyProducts = [
    {
      ...
      isNew: false,
      isFeatured: true,
      description: 'Classic black blazer perfect for formal occasions. Tailored fit with premium fabric.',
    ...
    },
    {
      ...
      flashSale: false,
      isNew: true,
      description: 'Comfortable striped polo shirt for casual wear. Available in multiple colors.',
    ...
    },
    {
      ...
      images: ['/images/products/athlatic shoes.png'],
      ...
      flashSale: false,
      isNew: true,
      description: 'Lightweight running shoes with excellent cushioning. Perfect for jogging and workouts.',
    ...
    },
    {
      ...
      images: ['/images/products/blue jeans.png'],
      categoryId: 1, // Clothing
      brandId: 4, // Levi's
      stock: 'in_stock',
      stockQuantity: 91,
      ...
      flashSale: true,
      isNew: false,
      description: 'Classic denim shorts with perfect fit. Great for summer casual wear.',
    ...
    },
    {
      ...
      images: ['/images/products/neckless.png'],
    ...
    },
    {
      ...
      flashSale: true,
      isNew: false,
      description: 'Warm and stylish winter coat with wool blend. Keeps you cozy in cold weather.',
    ...
    },
    {
      ...
      images: ['/images/products/sunglass.png'],
      ...
      flashSale: true,
      isNew: false,
      description: 'Classic aviator style sunglasses with UV protection. Timeless design.',
    ...
    },
    {
      ...
      images: ['/images/products/maxi.png'],
      categoryId: 1, // Clothing
      brandId: 7, // Biba
      stock: 'in_stock',
      stockQuantity: 52,
      ...
      flashSale: false,
      isNew: true,
      description: 'Beautiful floral print maxi skirt. Flowy and comfortable for any occasion.',
    ...
    },
    {
      ...
      images: ['/images/products/heals.png'],
      categoryId: 2, // Footwear
      brandId: 1, // Zara
      stock: 'in_stock',
      stockQuantity: 28,
      ...
      flashSale: true,
      isNew: false,
      description: 'Elegant ankle strap heels perfect for evening events. Comfortable and stylish.',
    ...
    },
    {
      ...
      images: ['/images/products/winter scarf.png'],
      categoryId: 5, // Accessories
      brandId: null,
      stock: 'in_stock',
      stockQuantity: 87,
      ...
      flashSale: false,
      isNew: true,
      description: 'Warm knit beanie hat for winter. Soft and comfortable material.',
      tags: ['beanie', 'hat', 'winter', 'knit'],
    },
  ];
  
  // Filter out products that already exist
  const newProducts = dummyProducts.filter(product => !existingProductIds.has(product.id));
