...
const ForgotPassword = () => {
    ...
    const onOtpSubmit = async (data) => {
        ...
        try {
            ...
            await api.post('/auth/user/verify-reset-otp', { email, otp: data.otp });
            setOtp(data.otp);
            setStep(3);
    ...
    const renderStep1 = () => (
        <form onSubmit={handleSubmitEmail(onEmailSubmit)} className="space-y-6">
            ...
            <div className="text-center">
                <Link to="/login" className="text-gray-500 hover:text-gray-700 text-sm flex items-center justify-center gap-2">
