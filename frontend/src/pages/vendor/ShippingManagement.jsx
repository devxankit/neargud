        ...
        <div className="flex overflow-x-auto">
          <button
            ...
            className={`flex items-center gap-2 px-4 sm:px-6 py-3 sm:py-4 border-b-2 transition-colors ${
              activeTab === 'zones' ? 'border-primary-600 text-primary-600' : 'border-transparent text-gray-600'
            }`}>
            <FiMapPin />
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 sm:px-6 py-3 sm:py-4 border-b-2 transition-colors ${
              activeTab === 'rates' ? 'border-primary-600 text-primary-600' : 'border-transparent text-gray-600'
            }`}>
            <FiTruck />
