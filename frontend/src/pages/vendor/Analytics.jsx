...
import { FiBarChart2, FiTrendingUp, FiPackage, FiShoppingBag, FiDollarSign } from 'react-icons/fi';
...
const Analytics = () => {
  ...
  useEffect(() => {
    ...
    const data = Object.values(ordersByDate).sort((a, b) => 
  ...
  const analyticsSummary = useMemo(() => {
    ...
    const earningsSummary = vendorId ? getVendorEarningsSummary(vendorId) : null;
  ...
  }, [vendorOrders, analyticsData, vendorId, getVendorProducts, getVendorEarningsSummary]);
