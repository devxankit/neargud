  ...
  return (
    <motion.div
      ...
      <div className="lg:hidden">
        ...
        <p className="text-sm sm:text-base text-gray-600">Advanced analytics and performance tracking</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-200">
          ...
          <p className="text-2xl font-bold text-gray-800">{formatPrice(metrics.totalRevenue)}</p>
        </div>
        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-200">
          <div className="flex items-center justify-between mb-2">
        ...
        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-200">
          ...
          <p className="text-2xl font-bold text-gray-800">{formatPrice(metrics.avgOrderValue)}</p>
        </div>
        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-200">
          <div className="flex items-center justify-between mb-2">
          ...
          <p className="text-2xl font-bold text-gray-800">{metrics.customerCount}</p>
        </div>
        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-200">
          <div className="flex items-center justify-between mb-2">
          ...
          <p className="text-2xl font-bold text-gray-800">{metrics.conversionRate.toFixed(1)}%</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-200">
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center">
            ...
            <span className="font-bold">{formatPrice(earnings?.totalEarnings || 0)}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-gray-600">Pending Earnings</span>
            <span className="font-semibold text-yellow-600">{formatPrice(earnings?.pendingEarnings || 0)}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-gray-600">Paid Earnings</span>
            <span className="font-semibold text-green-600">
              {formatPrice((earnings?.totalEarnings || 0) - (earnings?.pendingEarnings || 0))}
            </span>
          </div>
        </div>
      </div>
