        ...
        {tabs.map((tab, index) => {
          ...
          return (
            <motion.button
              ...
              className={`flex-shrink-0 flex flex-col items-center min-w-[70px] py-3 px-2 rounded-2xl transition-all duration-300 relative ${
                isActive
            ...
            >
              ...
              <span
                className={`text-xs font-semibold relative z-10 transition-all duration-200 ${
