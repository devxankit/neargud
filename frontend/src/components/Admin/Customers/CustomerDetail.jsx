...
const CustomerDetail = ({ customer, onClose, onUpdate }) => {
  ...
  const handleStatusToggle = async () => {
    ...
    onUpdate?.();
    onClose(); // Automatically close the modal after status toggle
  };
          ...
          >
            ...
            <div className="p-6 space-y-6">
                    ...
                    {isEditing ? (
                      <div className="flex gap-2 mb-2">
                        <input
                          ...
                          className="w-1/2 text-lg font-bold text-gray-800 px-3 py-1 border border-gray-300 rounded-lg"
                        />
                        <input
                          type="text"
                          name="lastName"
                    ...
                    {isEditing ? (
                      ...
                      <>
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg transition-colors font-semibold text-sm ${customer.status === 'active'
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <button
                  onClick={() => {
                    navigate(`/admin/customers/${customer._id || customer.id}?tab=orders`);
                    onClose();
                  }}
                ...
                <button
                  onClick={() => {
                    navigate(`/admin/customers/${customer._id || customer.id}?tab=transactions`);
                    onClose();
                  }}
                ...
                <button
                  onClick={() => {
                    navigate(`/admin/customers/${customer._id || customer.id}?tab=addresses`);
                    onClose();
                  }}
