...
import { generateSlug } from '../../../store/campaignStore';
...
const CampaignForm = ({ campaign, onClose, onSave }) => {
  ...
  // Get stores
  const { categories, getRootCategories, getCategoriesByParent, fetchAdminCategories: initCategories } = useCategoryStore();
