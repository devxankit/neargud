          ...
          : "bg-white border-primary-600 text-primary-700 hover:bg-primary-50"
            ...
            <div className="mb-8 p-6 bg-white rounded-[2rem] border border-gray-100 shadow-sm">
              ...
              <p className="text-gray-600 leading-relaxed text-sm font-medium">
                {product.description ||
                  `High-quality ${product.name.toLowerCase()} available in ${product.unit.toLowerCase()}. Carefully selected to ensure safety, performance, and best value for your requirements.`}
              </p>
                ...
                <div className="grid grid-cols-2 gap-3 mt-6">
                  {product.attributes.map((attr, idx) => (
                    <div
                      ...
                      <span className="block text-[10px] font-bold text-gray-400 uppercase tracking-tighter mb-0.5">
                        {attr.name}
                      </span>
            ...
            {vendor?.deliveryAvailable !== false ? (
              <div className="flex-1 flex gap-3">
                <button
                  ...
                  className={`flex-1 h-14 rounded-2xl font-bold uppercase text-xs tracking-widest transition-all active:scale-95 flex items-center justify-center gap-2 border-2 ${
                    product.stock === "out_of_stock" || product.isBuy === false
                ...
                <button
                  ...
                  className={`flex-1 h-14 rounded-2xl font-bold uppercase text-xs tracking-widest transition-all active:scale-95 shadow-lg ${
                    product.stock === "out_of_stock" || product.isBuy === false
