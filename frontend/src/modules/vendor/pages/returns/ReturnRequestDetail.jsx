          ...
          <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              <div>
                ...
                <p className="font-bold text-gray-800 text-lg">{formatPrice(returnRequest.refundAmount)}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <Badge
                  variant={returnRequest.refundStatus === 'processed' ? 'success' : returnRequest.refundStatus === 'failed' ? 'error' : 'warning'}
                  className="text-xs">
          ...
          <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200">
            ...
            <div className="space-y-2">
              ...
              <div className="border-t border-gray-200 pt-2 mt-2 flex justify-between">
                ...
                <span className="font-bold text-lg text-gray-800">{formatPrice(returnRequest.refundAmount)}</span>
              </div>
              ...
              {returnRequest.status === 'approved' && (
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-500">{new Date(returnRequest.updatedAt).toLocaleDateString()}</p>
                  </div>
                </div>
              )}
