...
import { FiMessageCircle, FiSend, FiUser, FiSearch, FiFilter, FiClock } from 'react-icons/fi';
    ...
    <motion.div
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="lg:hidden">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">Chat</h1>
          <p className="text-sm sm:text-base text-gray-600">Communicate with customers and support</p>
        </div>
              ...
              {messages.map((msg) => (
                <div
                  ...
                  <div
                    ...
                    <p
                      className={`text-xs mt-1 ${msg.sender === 'vendor' ? 'text-primary-100' : 'text-gray-500'
                        }`}>
