    ...
    <motion.div
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="lg:hidden">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">Wallet History</h1>
          <p className="text-sm sm:text-base text-gray-600">View your earnings and payment history</p>
        </div>
      </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          ...
          <ExportButton
            ...
            headers={[
              ...
              { label: 'Payment Method', accessor: (row) => row.paymentMethod || 'N/A' },
            ]}
              ...
              <div
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <Badge
                      variant={transaction.type === 'earning' ? 'info' : 'success'}>
                      {transaction.type === 'earning' ? 'Earning' : 'Settlement'}
                    </Badge>
                    {transaction.orderId && (
