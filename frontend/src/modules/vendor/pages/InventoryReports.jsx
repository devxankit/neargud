...
import { FiBarChart, FiPackage, FiTrendingDown, FiAlertCircle } from 'react-icons/fi';
  ...
  return (
    <motion.div
      ...
      <div className="lg:hidden">
        ...
        <p className="text-sm sm:text-base text-gray-600">View inventory analysis and stock reports</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-200">
          ...
          <p className="text-2xl font-bold text-gray-800">{formatPrice(totalStockValue)}</p>
        </div>
        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-200">
